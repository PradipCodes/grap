...
abstract class UserType implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Model\\Map\\UserTypeTableMap';
    ...
    /**
     * Initializes internal state of App\Model\Base\UserType object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\App\Model\UserType The current object (for fluent API support)
     */
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[UserTypeTableMap::COL_CODE] = true;
        }
    ...
    public function setTypeName($v)
    {
        ...
        if ($this->type_name !== $v) {
            $this->type_name = $v;
            $this->modifiedColumns[UserTypeTableMap::COL_TYPE_NAME] = true;
        }
    ...
    public function setIsSystem($v)
    {
        ...
        if ($this->is_system !== $v) {
            $this->is_system = $v;
            $this->modifiedColumns[UserTypeTableMap::COL_IS_SYSTEM] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UserTypeTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UserTypeTableMap::translateFieldName('TypeName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UserTypeTableMap::translateFieldName('IsSystem', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_system = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Model\\UserType'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTypeTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(UserTypeTableMap::COL_TYPE_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'type_name';
        }
        if ($this->isColumnModified(UserTypeTableMap::COL_IS_SYSTEM)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Model\UserType
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Model\UserType The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTypeTableMap::COL_CODE)) {
            $criteria->add(UserTypeTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(UserTypeTableMap::COL_TYPE_NAME)) {
            $criteria->add(UserTypeTableMap::COL_TYPE_NAME, $this->type_name);
        }
        if ($this->isColumnModified(UserTypeTableMap::COL_IS_SYSTEM)) {
            $criteria->add(UserTypeTableMap::COL_IS_SYSTEM, $this->is_system);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Model\UserType (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Model\UserType Clone of current object.
     * @throws PropelException
     */
